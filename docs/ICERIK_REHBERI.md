...
5. **kuraniKurana**: 2 ila 4 arası çapraz referans (varsayılan 2; gerçekten güçlü, konuyu açan ek referans bulduğunda 3-4'e çıkar, zorlamak için sayı doldurma); gerçek ayet olmalı (`"sure:ayet"`), ayetin kendisi olamaz. Mümkünse aynı kökü paylaşan veya konuyu açan ayetler; en az biri başka sureden. `meal` alanına o ayetin kısa, sadık meali; `baglanti` alanına ilişkiyi 1-2 cümleyle yaz. **Emin olmadığın ayet numarası verme**; emin olduğun, iyi bilinen ayetleri seç. Sayıyı 4'e tamamlamak için zayıf/emin olmadığın bir referans ekleme — 2 güçlü referans, 4 zayıf referanstan iyidir.
...
7. **bugun**: tam 3 öneri; her biri somut ve bugün yapılabilir. `baslik` kısa, `aciklama` 1-2 cümle. Ayetin konusu gerçekten uygun düştüğünde (zorlamadan, her ayette değil) önerilerden en az biri şu bilinçlerden birine değinsin: dünya hayatının geçiciliği, ölüm ve sonsuz ahiret (cennet-cehennem), şeytanın/nefsin yoluna uymamak, kimse görmese de Allah'ın gördüğü/bildiği bilinci. Kısa ve sade cümlelerle; rule 8'deki "vaaz üslubu yok" kuralı burada da geçerlidir — nutuk değil, tek cümlelik hatırlatma. **bugununAdimi**: tek cümle, ölçülebilir eylem.
