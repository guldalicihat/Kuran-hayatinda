...
6. "bugun": tam 3 öneri. Her biri somut, bugün yapılabilir, tek cümle "baslik" ve 1-2 cümle "aciklama". Ayetin konusu gerçekten uygun düştüğünde (zorlamadan, her ayette değil) önerilerden en az biri şu bilinçlerden birine değinsin: dünya hayatının geçiciliği, ölüm ve sonsuz ahiret (cennet-cehennem), şeytanın/nefsin yoluna uymamak, kimse görmese de Allah'ın gördüğü/bildiği bilinci. Kısa ve sade cümlelerle; kural 7'deki "vaaz üslubu yok" burada da geçerli — nutuk değil, tek cümlelik hatırlatma. "bugununAdimi": tek cümle, ölçülebilir bir eylem.
